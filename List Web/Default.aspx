                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="DetailPokemon.aspx?Id=<%#Eval("Id") %>">Ver detalle</a>
                            <asp:Button Text="btn" CssClass="btn btn-primary" runat="server" ID="btnBtn" CommandArgument='<%#Eval("ID") %>' CommandName="PokemonID" OnClick="btnBtn_Click"/>
                        </div>
                    </div>
                </div>
            </ItemTemplate>
